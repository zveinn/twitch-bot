...
var (
	...
	scopes       = []string{oidc.ScopeOpenID, "channel_subscriptions", "bits:read", "whispers:read", "channel:moderate"}
	claims       = oauth2.SetAuthURLParam("claims", `{"id_token":{"email":"anon@zkynet.io"}}`)
	redirectURL  = "http://localhost/redirect"
	oauth2Config *oauth2.Config
	oidcIssuer   = "https://id.twitch.tv/oauth2"
	oidcVerifier *oidc.IDTokenVerifier
	cookieSecret = []byte("asdasda2342342342")
...
func main() {
	...
	fmt.Println("Started running on http://localhost")
